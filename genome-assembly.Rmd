...
In particular, the N50 (length of a contig, such that all the contigs of at least the same length together cover at least 50% of the assembly), number of contigs, total length of all contigs, and the length of the largest contig are all important metric that are often reported with genome assemblies.
...
### Prokaryotic genome
CheckM used to be the gold standard for bacterial completeness analysis. After nine years, CheckM2 has released in 2023!
...
CheckM will automatically determine the lineage of our genome and then select a suite of single-copy marker genes relevant to that taxonomic group. The final output will provide completeness (what percentage of expected marker genes were detected) and contamination (what percentage of expected marker genes were detected more than once).


```--threads ``` is the parameter for CPUs.
### Eukaryotic genome
BUSCO is an alternative completeness analysis tool with the added benefit of working with both prokaryotic and eukaryotic lineages. 

### Viral genome
You may still want to do this step, even if you didn't set out to assemble a viral genome! 
